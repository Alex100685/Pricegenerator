...
import ua.autoshop.utils.sixlsx.excel.xlsx.SimpleXLSXWorkbook.ModifyEntry;
import ua.autoshop.utils.sixlsx.excel.xlsx.SimpleXLSXWorkbook.XMLStreamCreator;
...
public class Sheet {
	...
	public static final Cell[] EMPTY_ROW = new Cell[20];
