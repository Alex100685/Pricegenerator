...
public class MarginMaker {
    ...
    public static Double addWholesalePrice(String strPrice, Margin margin){
        ...
        try {
            ...
            price = Double.parseDouble(strPrice)*margin.getUsdCurrencyRate();
        }catch (Exception e){
            CommonVariables.writeToFile = false;
            return 0.0;
        }
    ...
    public static Double getTrueIncomePrice(String strPrice, Margin margin){
    ...
    public static Double getTrueIncomePriceNoCurrency(String strPrice, Margin margin){
