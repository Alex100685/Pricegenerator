...
public class AsgModelDaoImpl extends DaoImpl<AsgModel> {
    ...
    @Override
    protected boolean conditionToSave(AsgModel asgModel) {
        return asgModel.getAvailable()!=null && !asgModel.getAvailable().equals("") && !asgModel.getAvailable().equals("0");
    }

    @Override
    protected void fillPriceFields(AsgModel price, Margin margin, Margin wholeSaleMargin, CsvCreator csvCreator) {
